...
import com.mp.playcardsmanager.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
        ...
        alertDialog.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int which) {
                ...
                if(newCategory != null)
                {
                    ...
                    Snackbar.make(drawer,"The " + newCategory.getName()+" category was added!",Snackbar.LENGTH_SHORT)
                            .show();
                }
            }
        });
            ...
            imageFolder.putFile(saveUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            mDialog.dismiss();
                            Toast.makeText(Home.this, "Photo uploaded!", Toast.LENGTH_SHORT).show();
    ...
    private void loadMenu() {
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongclick) {
                        ...
                        Intent deckList = new Intent(Home.this,DeckList.class);
                        deckList.putExtra("CategoryId",adapter.getRef(position).getKey());
        ...
        adapter.notifyDataSetChanged();//refreshesdata
    ...
    //CONTEXT MENU Delete & Update functions
